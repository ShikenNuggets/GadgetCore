...
namespace Gadget::SDL_Utils
{
	...
	AxisId JoystickToAxisId(Uint8 axis);
	AxisId JoystickHorizontalHatToAxisId(Uint8 hat);
	AxisId JoystickVerticalHatToAxisId(Uint8 hat);
	ButtonId JoystickToButtonId(Uint8 button);
}
